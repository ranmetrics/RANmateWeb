...
function showSites(str) {
    if (str == "") {
        ...
        if (str.startsWith("DCN-") && (currentMetricType !== "DCN")) {
            currentMetricType = "DCN";
            clearTickBoxes();
...
//                document.getElementById("EE").checked = false;
        ...
        xmlhttp.open("GET","RANMateMetrics_OpCoCellList.php?switch="+str,true);
        xmlhttp.send();
    }
}
...
function showInterfaces(str) {
    ...
    //                document.getElementById("interface").selectedIndex = 0;
            ...
            xmlhttp.open("GET","RANMateMetrics_InterfaceList.php?site="+str,true);
            xmlhttp.send();
        }
    }
}
