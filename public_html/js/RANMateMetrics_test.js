...
var chartNames = [["chart1upper", "chart2upper", "chart3upper", "chart4upper"],["chart1lower", "chart2lower", "chart3lower", "chart4lower"]];
...
function getTrafficMergePercentageSql () {
    ...
    return "SELECT DATE(measurement_time) AS measurement_time, metric_name, " +
        "(SUM(operator1) * 100)/(SUM(operator1) + SUM(operator2) + SUM(operator3) + SUM(operator4)) AS VF, " +
        "(SUM(operator2) * 100)/(SUM(operator1) + SUM(operator2) + SUM(operator3) + SUM(operator4)) AS O2, " +
        "(SUM(operator3) * 100)/(SUM(operator1) + SUM(operator2) + SUM(operator3) + SUM(operator4)) AS THREE, " +
        "(SUM(operator4) * 100)/(SUM(operator1) + SUM(operator2) + SUM(operator3) + SUM(operator4)) AS EE " +
        "FROM jflow_viewer_output_pivoted " +
...
//                              // [MW] THIS IS THE IMPORTANT ONE TO UNCOMMENT FOR TRACING
            ...
            //                                                console.log("   How is measurement " + entry + "=" + measurement[entry] + " being stored?");
                                            ...
                                            var trafficCharts = new Array(8);
                                            for (nero=0; nero < 8; nero++) {
                                            ...
                                            if (trafficTableOutput) {
                                                ...
                                                for (row = 0; row < 2; row++) {
                                                    for (col = 0; col < 4; col++) {
                                                        ...
                                                        gridCanvas[row][col] = document.getElementById(chartNames[row][col]);
